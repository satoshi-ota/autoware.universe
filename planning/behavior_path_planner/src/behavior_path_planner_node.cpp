...
: Node("behavior_path_planner", node_options)
{
...

  {
    ...
    //   auto manager =
    //     std::make_shared<StartPlannerModuleManager>(this, "start_planner",
    //     p.config_start_planner);
    //   planner_manager_->registerSceneModuleManager(manager);
    //   path_candidate_publishers_.emplace(
    ...
    //       auto manager = std::make_shared<LaneChangeModuleManager>(
    //         this, module_topic, p.config_ext_request_lane_change_right,
    ...
    //       auto manager = std::make_shared<LaneChangeModuleManager>(
    //         this, module_topic, p.config_ext_request_lane_change_left,
